...
app.add_middleware(
    ...
    # Permitir subdominios de Cloudflare Pages (.pages.dev) y GitHub Pages (.github.io)
    allow_origin_regex=r"https://([a-zA-Z0-9-]+\.)*(pages\.dev|github\.io)",
    allow_methods=["*"],
    allow_headers=["*"],
)
